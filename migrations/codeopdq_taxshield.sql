...
ADD UNIQUE KEY `bank_routing` (`bank_routing`);
...
VALUES (
        1,
        1,
        '9e65d728f5cb25ce5a91ab19db0abf4aecb3480b81b32e8e42222bfca546e982',
        '2025-09-19 03:55:31',
        '2025-09-19 06:55:31'
    ),
    (
        2,
        1,
        '6ac2aedbb83f43b4312da260fd78e202b868b54c0cca1859f7b49cba9d9461bc',
        '2025-09-20 07:31:23',
        '2025-09-20 10:31:23'
    ),
    (
        3,
        1,
        '86c7103ea30745d3782eb37fc0c6cf55f487442c7fc028fdb0f90f2605bb6760',
        '2025-09-20 07:31:23',
        '2025-09-20 10:31:23'
    ),
    (
        4,
        1,
        '95b846537d34a06a64d95b4d86d5f757ab887fd17aa5dbde0591789b97c0f595',
        '2025-09-20 07:37:16',
        '2025-09-20 10:37:16'
    );
...
VALUES (
        1,
        'kaleb',
        'kalebasnake2019@gmail.com',
        '$2y$10$AE3X78lG2Mx31pwY/pe.BOizmQBkcKfn5n4uKGeQrgFxQJQMUtqQa',
        'Kaleb',
        'admin',
        '2025-09-16 10:39:55'
    ),
    (
        ...
        'alemu',
        'alemu@gmail.com',
        '$2y$10$yPSgd5ccCnI/T.zv3JareuoaIXPuHmONhnYcfy08cqKy9BznCqHVS',
        'alemu kebede',
        'admin',
        '2025-09-17 20:16:44'
    );
...
--
ALTER TABLE `companies`
ADD CONSTRAINT `companies_ibfk_1` FOREIGN KEY (`bank_id`) REFERENCES `banks` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `checks` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ADD CONSTRAINT `checks_ibfk_3` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`) ON DELETE CASCADE;
